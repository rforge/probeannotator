...
bowtie.get.makeAlignmentCommand <- function(file.in, file.out, index, bowtie.path = "/net/sib-pc12/export/big/csoneson/Projects/almac_annotation/bowtie-1.0.0", index.dir = NULL,p=0) {
  #parameters
