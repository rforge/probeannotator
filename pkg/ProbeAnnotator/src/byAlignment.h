        ...
        while (!ifs.eof()) {
            ...
            if (!line.empty()) {
                ...
                if (score < min_score && ref_index >= 0) {
                    ...
                    DoGeneMapping_EXONINTRON(offset + txDbStart[ref_index] - downstream, offset + txDbStart[ref_index] - downstream + 20, 
        ...
        while (!ifs.eof()) {
            ...
            if (!line.empty()) {
                ...
                if (score < min_score && ref_index >= 0) {
                    ...
                    DoGeneMapping_NO_INTRONEXON(offset + txDbStart[ref_index] - downstream, offset + txDbStart[ref_index] - downstream + 20, 
                            txDbFullStart[ref_index], txDbFullEnd[ref_index],
                            txDbExtendedStart[ref_index], txDbExtendedEnd[ref_index],
                            txDbStart[ref_index], txDbEnd[ref_index],
        ...
        while (!ifs.eof()) {
            ...
            if (!line.empty()) {
                ...
                if (score < min_score && ref_index >= 0) {
                    ...
                    DoGeneMapping_EXON_NO_INTRON(offset + txDbStart[ref_index] - downstream, offset + txDbStart[ref_index] - downstream + 20, 
                            txDbFullStart[ref_index], txDbFullEnd[ref_index],
                            txDbExtendedStart[ref_index], txDbExtendedEnd[ref_index],
                            txDbStart[ref_index], txDbEnd[ref_index],
                            txDbPromotorStart[ref_index], txDbPromotorEnd[ref_index],
