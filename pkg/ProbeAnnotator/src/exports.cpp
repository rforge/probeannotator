...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        SEXP __result = annotateByAlignment(inputData, dfGENETXData, dfGENETXGroupData, dfEXONData, stackEXONData, dfORGDBData, vecORGDBColumnsData, vecSEPData, vecRangesData, listFunctionParamData);
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< SEXP >::type vecRangesData(vecRangesDataSEXP );
        Rcpp::traits::input_parameter< SEXP >::type listFunctionParamData(listFunctionParamDataSEXP );
        SEXP __result = annotateByLocation(inputData, dfGENETXData, dfGENETXGroupData, dfEXONData, stackEXONData, dfORGDBData, vecORGDBColumnsData, vecSEPData, vecRangesData, listFunctionParamData);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
